        ...
        <#if totalValorVenta??><cbc:LineExtensionAmount currencyID="${moneda}">${totalValorVenta}</cbc:LineExtensionAmount></#if>
        <#---------->
        <#--PUNTO2-->
        <#---------->
        ...
        <#--los impuestos.-->
        <#if totalPrecioVenta??><cbc:TaxInclusiveAmount currencyID="${moneda}">${totalPrecioVenta}</cbc:TaxInclusiveAmount></#if>
        <#---------->
        <#--PUNTO3-->
        <#---------->
        <#--TOTAL DE DESCUENTOS-->
        ...
        <cbc:PayableAmount currencyID="${moneda}">${importeTotal}</cbc:PayableAmount>
