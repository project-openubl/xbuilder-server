...
public class CreditNote_ProveedorSinCodigoPostalGenerator implements CreditNoteInputGenerator {
    ...
    public Optional<String> getSnapshot() {
        return Optional.of("xml/cases/proveedorsincodigopostal/CreditNote.xml");
    }
