...
public class Caso18_CreditNoteGenerator implements CreditNoteInputGenerator {
    ...
    public static CreditNoteInputModel getInstance() {
        ...
        if (creditNote == null) {
            synchronized (Caso18_CreditNoteGenerator.class) {
                ...
                if (creditNote == null) {
                    ...
                    // get invoice
                    InvoiceInputModel invoice = Caso14_InvoiceGenerator.getInstance();
