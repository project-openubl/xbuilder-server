...
public class Caso39_CreditNoteGenerator implements CreditNoteInputGenerator {
    ...
    public static CreditNoteInputModel getInstance() {
        ...
        if (creditNote == null) {
            synchronized (Caso39_CreditNoteGenerator.class) {
                ...
                if (creditNote == null) {
                    ...
                    // get invoice
                    InvoiceInputModel invoice = Caso36_InvoiceGenerator.getInstance();
