 ...
 */
package org.openublpe.xmlbuilder.inputdata.generator.retention;
...
public class Retention_SimpleInputGenerator implements RetentionInputGenerator {

    @Override
    public RetentionInputModel getInput() {
        Calendar calendar = Calendar.getInstance();
        calendar.set(2019, Calendar.NOVEMBER, 8);


        RetentionInputModel input = new RetentionInputModel();
        input.setSerie("R001");
        input.setNumero(1);
    ...
    public Optional<String> getSnapshot() {
        return Optional.of("xml/retention/Simple.xml");
    }
}
