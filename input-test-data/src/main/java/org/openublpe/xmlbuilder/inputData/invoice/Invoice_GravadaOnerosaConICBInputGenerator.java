...
public class Invoice_GravadaOnerosaConICBInputGenerator extends AbstractInvoiceInputGenerator implements InvoiceInputGenerator {
    ...
    public Optional<String> getSnapshot() {
        return Optional.of("xml/invoice/Gravada_Onerosa_ICB.xml");
    }
